...
export default function ProductDetailsPage() {
    ...
    useEffect(() => {
       fetch(`http://localhost:5173/api/products/${id}`).then(response => response.json()).then(data => setProducts(data)).catch(error => console.log(error)).finally( ()=>setLoading(false));
